...
/*! @brief The function signature for window position_ callbacks.
 *
 *  This is the function signature for window position_ callback functions.
 *
...
/*! @brief The function signature for cursor position_ callbacks.
 *
 *  This is the function signature for cursor position_ callback functions.
 *
 *  @param[in] window The window that received the event.
 ...
 *  window size and position_ may be overriden by previously saved values.
 *
 ...
 *  default be set to the window title passed to this function.  The instance_
 ...
 *  guarantee that surface creation or even instance_ creation is possible.
 ...
 *  required.
 *
 *  @param[in] instance_ The instance_ that the physical device belongs to.
