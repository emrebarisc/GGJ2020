...
typedef struct _GLFWwindowX11
{
    ...
    // Cached position_ and size used to filter out duplicate events
    int             width, height;
    int             xpos, ypos;

    // The last received cursor position_, regardless of source
    int             lastCursorPosX, lastCursorPosY;
    // The last position_ the cursor was warped to by GLFW
