...
// Tick native window styles to match attributes
//
...
// Tick window framebuffer transparency
//
                                   ...
                                   WPARAM wParam, LPARAM lParam)
{
    ...
    switch (uMsg)
    {
        ...
        case WM_DROPFILES:
        {
            ...
            // Move the mouse to the position_ of the drop
                              ...
                              const _GLFWfbconfig* fbconfig)
{
    ...
    if (window->monitor)
    {
        ...
        //       correct position_ and size cannot be known until the monitor
...
void _glfwPlatformSetCursorPos(_GLFWwindow* window, double xpos, double ypos)
{
    ...
    // Store the new position_ so it can be recognized later
